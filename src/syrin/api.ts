...
export async function stopMood(): Promise<void> {
	...
	await fetch(link(), fetchOptions()).catch(catchErr('stopMood'));
}
...
export async function playMood(id: number): Promise<void> {
	...
	await fetch(link(id), fetchOptions()).catch(catchErr('playMood'));
}
...
export async function playElement(id: number): Promise<void> {
	...
	await fetch(link(id), fetchOptions()).catch(catchErr('playElement'));
}
