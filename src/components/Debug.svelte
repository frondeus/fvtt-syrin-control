...
const currentlyPlaying = stores.currentlyPlaying;
...
<table>
  ...
  <tr> <td> Currently Playing </td>         <td> {JSON.stringify(($currentlyPlaying)?.mood?.name)} {JSON.stringify(($currentlyPlaying)?.soundset?.name)} </td> </tr>
</table>
